...
extension ViewController{
    fileprivate func setupFilterBar(){
        ...
        filterBar.itemList = ["无", "缩放", "灵魂出窍","抖动","闪白","毛刺","幻觉"]
...
extension ViewController{
    ...
    fileprivate func setupScaleShaderProgram(){
        setupShaderProgramWithName("Scale")
        
    }
    fileprivate func setupSoulOutShaderProgram(){
        setupShaderProgramWithName("SoulOut")
        
    }
    fileprivate func setupShakeShaderProgram(){
        setupShaderProgramWithName("Shake")
    }
    fileprivate func setupShineWhiteShaderProgram(){
        setupShaderProgramWithName("ShineWhite")
    }
    fileprivate func setupGlitchShaderProgram(){
        setupShaderProgramWithName("Glitch")
    }
    fileprivate func setupVertigoShaderProgram(){
        setupShaderProgramWithName("Vertigo")
    }
