...
extension ViewController{
    fileprivate func setupFilterBar(){
        ...
        filterBar.didScrollToIndex = {[unowned self](bar, index) in
            ...
            case 1:
                self.setupSplitScreen_2ShaderProgeam()
            case 2:
                self.setupSplitScreen_3ShaderProgeam()
            case 3:
                self.setupSplitScreen_4ShaderProgeam()
            case 4:
                self.setupSplitScreen_6ShaderProgeam()
            default:
                self.setupSplitScreen_9ShaderProgeam()
            }
...
extension ViewController{
    ...
    fileprivate func setupSplitScreen_2ShaderProgeam(){
        setupShaderProgramWithName("SplitScreen_2")
        
    }
    fileprivate func setupSplitScreen_3ShaderProgeam(){
        setupShaderProgramWithName("SplitScreen_3")
        
    }
    fileprivate func setupSplitScreen_4ShaderProgeam(){
        setupShaderProgramWithName("SplitScreen_4")
    }
    fileprivate func setupSplitScreen_6ShaderProgeam(){
        setupShaderProgramWithName("SplitScreen_6")
    }
    fileprivate func setupSplitScreen_9ShaderProgeam(){
        setupShaderProgramWithName("SplitScreen_9")
    }
