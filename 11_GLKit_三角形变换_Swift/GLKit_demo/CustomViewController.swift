...
//        使用索引
        ...
        glVertexAttribPointer(GLuint(GLKVertexAttrib.color.rawValue), 3, GLenum(GL_FLOAT), GLboolean(GL_FALSE), Int32(MemoryLayout<GLfloat>.size)*6, UnsafeMutablePointer(bitPattern: MemoryLayout<GLfloat>.size*3))
